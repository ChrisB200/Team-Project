...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/chris/code/crown-and-dial/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/chris/code/crown-and-dial/public/storage',
...
'admin.watches.index','admin.watches.create','admin.watches.store','admin.watches.show','admin.watches.edit',
'admin.watches.update','admin.watches.destroy','admin.suppliers.index','admin.suppliers.create','admin.suppliers.store',
'admin.suppliers.show','admin.suppliers.edit','admin.suppliers.update','admin.suppliers.destroy','dashboard',
'profile.edit','profile.update','profile.destroy','admin.dashboard','register','login','password.request','password.email',
...
'about','admin.dashboard','admin.suppliers.create','admin.suppliers.edit','admin.suppliers.index',
'admin.suppliers.show','admin.watches.create','admin.watches.edit','admin.watches.index','auth.confirm-password',
'auth.forgot-password','auth.login','auth.register','auth.reset-password','auth.verify-email',
'basket','checkout','components.application-logo','components.auth-session-status','components.danger-button',
'components.dropdown','components.dropdown-link','components.icon','components.input-error','components.input-label',
...
'components.text-input','contact','credential','dashboard','home',
'layout','layouts.app','layouts.guest','layouts.navigation','master',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','watches.index',
'watches.show','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
