...
'auth.reset-password','auth.verify-email','basket','checkout','components.application-logo',
...
'components.secondary-button','components.text-input','contact','credential','dashboard',
'home','layout','layouts.app','layouts.guest','layouts.navigation',
'master','product_listing','products','profile.edit','profile.partials.delete-user-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
